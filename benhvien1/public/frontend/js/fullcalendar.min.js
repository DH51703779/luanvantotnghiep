...
(function (m, ma) {
    ...
    function Rb(a, b, e) {
        ...
        function ra(h, O) {
            for (
                var x = N(K.visStart), A = ba(N(x), 1), ta = 0;
                ta < Ba;
                ta++
            ) {
    ...
    function sc() {
        ...
        function g(o, s) {
            ...
            for (v = 0; v < F; v++) {
                ...
                if (($ = r.element)) {
                    $[0].style.width =
                        Math.max(0, r.outerWidth - r.hsides) + "px";
        ...
        function S(o, s, v) {
            ...
            s.draggable({
                ...
                drag: function (I, R) {
                    D =
                        Math.round((R.position.top - J.top) / w) *
                        u("slotMinutes");
                    if (D != Z) {
                        M || F(D);
                        Z = D;
        ...
        function Q(o, s, v) {
            ...
            s.resizable({
                ...
                resize: function (M, k) {
                    F = Math.round(
                        (Math.max(J, s.height()) - k.originalSize.height) / J
                    );
                    if (F != r) {
                        v.text(
                            W(
    ...
    function Kb(a, b, e) {
        ...
        function f(G, p) {
            return b.trigger.apply(
                b,
                [G, p || da].concat(Array.prototype.slice.call(arguments, 2), [
                    da,
                ])
            );
        }
    ...
    function Qb() {
        ...
        function j(i) {
            ...
            for (C = 0; C < P; C++) {
                ...
                if ((B = E.element))
                    B[0].style.width =
                        Math.max(0, E.outerWidth - E.hsides) + "px";
            }
        }
        function t(i) {
            var C,
    ...
    var Ya = {
            ...
            dayNamesShort: ["Thứ 2", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
            buttonText: {
                prev: "&nbsp;&#9668;&nbsp;",
                next: "&nbsp;&#9658;&nbsp;",
                prevYear: "&nbsp;&lt;&lt;&nbsp;",
    ...
    Aa.formatDate = Oa;
    Aa.formatDates = ib;
    var lc = ["Thứ 2", "mon", "tue", "wed", "thu", "fri", "sat"],
        Ab = 864e5,
        cc = 36e5,
        wc = 6e4,
        dc = {
