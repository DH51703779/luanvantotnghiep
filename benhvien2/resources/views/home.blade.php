                        ...
                        <div class="row align-items-center no-gutters">
                            ...
                            <div class="col-lg-5">
                                <div class="dept_thumb">
                                    <img src="public/img/gallery/department_man.png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- single_content  -->
                ...
                <div class="single-testimonial text-center">
                    ...
                    <div class="testimonial-caption ">
                        <div class="testimonial-top-cap">
                            <img src="public/img/gallery/testimonial.png" alt="">
                        ...
                        <div class="testimonial-founder d-flex align-items-center justify-content-center">
                            <div class="founder-img">
                                <img src="public/img/gallery/Homepage_testi.png" alt="">
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="public/img/gallery/team2.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="public/img/gallery/team3.png" alt="">
                        </div>
                        <div class="team-caption">
    ...
    <!-- Team End -->
     ...
     <div class="contact-form-main">
        ...
        <div class="from-left d-none d-lg-block">
            <img src="public/img/gallery/contact_form.png" alt="">
        </div>
    </div>
    <!-- Contact form End -->
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        <div class="blog-img">
                            <img src="public/img/gallery/blog1.png" alt="">
                        </div>
                        <div class="blogs-cap">
                            <div class="date-info">
                                <span>Health</span>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        <div class="blog-img">
                            <img src="public/img/gallery/blog2.png" alt="">
                        </div>
                        <div class="blogs-cap">
                            <div class="date-info">
                                <span>Checkup</span>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        <div class="blog-img">
                            <img src="public/img/gallery/blog3.png" alt="">
                        </div>
                        <div class="blogs-cap">
                            <div class="date-info">
                                <span>Operation</span>
